export const SITE_NAME = "EveryKit Text";
export const KIT_NAME = "Text";
export const KIT_SLUG = "text";
export const SITE_TAGLINE = "Count, convert and clean text in a click";
