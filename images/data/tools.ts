...
const BATCH_ANSWER: Faq = {
  ...
  a: "Yes. Drop in as many as you like and they are handled one after another, with the finished set offered as a single ZIP. They go one at a time on purpose — decoding twenty large photos simultaneously is how a phone browser runs out of memory and kills the tab.",
};
...
export const tools: Tool[] = [
  {
    ...
    seoTitle: "Resize images online — batch, free, never uploaded",
    description:
    ...
    faq: [
      ...
      { q: "Will resizing lose quality?", a: "Making an image smaller always discards detail — that is what smaller means — and saving as JPEG or WebP compresses it again on the way out. The quality slider controls how much. Making an image larger cannot add detail back, only guess at it." },
    ],
  },
  {
    slug: "convert",
    ...
    seoTitle: "Convert images between JPG, PNG and WebP — free, never uploaded",
    description:
  ...
  },
  {
    ...
    seoTitle: "Remove EXIF data from photos — lossless, free, never uploaded",
    description:
    ...
    intro: [
      ...
      "It does it without re-encoding the picture. The metadata segments are dropped and everything else is copied through byte for byte, so the image data in the file you get back is identical to the one you put in — not re-saved, not softened, not a fraction larger.",
    ],
    faq: [
      UPLOAD_ANSWER,
      BATCH_ANSWER,
