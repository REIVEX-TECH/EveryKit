export const SITE_NAME = "EveryKit Images";
export const KIT_NAME = "Images";
export const KIT_SLUG = "images";
export const SITE_TAGLINE = "Resize, convert and clean up photos";
