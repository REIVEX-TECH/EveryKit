export const SITE_NAME = "EveryKit Dev";
export const KIT_NAME = "Dev";
export const KIT_SLUG = "dev";
export const SITE_TAGLINE = "Small developer tools, nothing leaves your browser";
