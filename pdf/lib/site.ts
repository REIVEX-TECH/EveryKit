export const SITE_NAME = "EveryKit PDF";
export const KIT_NAME = "PDF";
export const KIT_SLUG = "pdf";
export const SITE_TAGLINE = "Split, merge and shrink PDFs without uploading them";
