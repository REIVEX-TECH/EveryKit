export const SITE_NAME = "EveryKit Background";
export const KIT_NAME = "Background";
export const KIT_SLUG = "background";
export const SITE_TAGLINE = "Remove backgrounds in your browser, nothing uploaded";
...
export const SITE_URL = origin(
  ...
  "https://background.useeverykit.com",
);
