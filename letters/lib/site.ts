export const SITE_NAME = "EveryKit Letters";
export const KIT_NAME = "Letters";
export const KIT_SLUG = "letters";
export const SITE_TAGLINE = "Formal letters, written for you";
