...
export const metadata: Metadata = {
  title: "Privacy",
  description:
    "What EveryKit Newsletter does and does not collect. Your newsletter and the images you add stay in your browser. If you give us your email, we store that.",
    ...
    <div className="ek-shell max-w-[680px] py-16">
      ...
      <div className="mt-10 space-y-8 text-[16px] text-text-light">
        <section>
          ...
          <p className="mt-2">
            It is never uploaded. The whole builder runs in the browser tab. There is no
            server that receives your newsletter, your text or the images you add, because
            this kit does not have a backend at all.
          </p>
          <p className="mt-2">
            The images you drop in are held in the tab&apos;s memory while you work and are
            written straight into the folder you export. They do not pass through us. When
            you close the tab they are gone.
          </p>
          <p className="mt-2">
            You do not have to take this on trust. Open your browser&apos;s developer tools,
            switch to the network tab, and build and export a newsletter. No request carries
            what you made.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2">
            The export is zipped in the browser by a small library that ships with the page,
            so there is no third-party download and nothing is fetched to do the work.
          </p>
          <p className="mt-2">
            ...
            this page is allowed to contact. Your newsletter is not on that list, and could
            not be added to it without changing this page too.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2">
            Before your first export we ask for your email address, and you can skip it. You
            are asked once per session; after that every export in that session goes straight
            through.
          </p>
          <p className="mt-2">
            ...
            linked to anything you built, because none of that reaches us. We use it to tell
            you when a new kit launches. We do not sell it and we do not pass it on.
          </p>
          <p className="mt-2">
            To be removed, email{" "}
