export const SITE_NAME = "EveryKit Newsletter";
export const KIT_NAME = "Newsletter";
export const KIT_SLUG = "newsletter";
export const SITE_TAGLINE = "Drag and drop email newsletters, no code";
...
export const SITE_URL = origin(
  ...
  "https://newsletter.useeverykit.com",
);
