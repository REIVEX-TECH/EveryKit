...
const CONTENT_SECURITY_POLICY = [
  ...
  // The builder previews the email in an iframe fed a same-origin blob URL of
  // the generated HTML, so 'self' and blob: are framed here. The checkout
  // overlay is an iframe served by Lemon Squeezy. Nothing else is framed.
  "frame-src 'self' blob: https://*.lemonsqueezy.com",
  "object-src 'none'",
  "base-uri 'self'",
