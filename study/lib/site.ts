export const SITE_NAME = "EveryKit Study";
export const KIT_NAME = "Study";
export const KIT_SLUG = "study";
export const SITE_TAGLINE = "Calculators and helpers for students";
