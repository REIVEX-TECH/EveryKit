export const SITE_NAME = "EveryKit Ringtone";
export const KIT_NAME = "Ringtone";
export const KIT_SLUG = "ringtone";
export const SITE_TAGLINE = "Trim any song into a ringtone";
...
export const SITE_URL = origin(
  ...
  "https://ringtone.useeverykit.com",
);
