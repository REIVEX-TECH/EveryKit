...
export const kitTools: Record<string, KitTool[]> = {
  ...
  background: [
    ...
    { name: "White background", path: "/white-background", synonyms: ["white bg", "product photo", "make background white", "change background to white", "get white background"], intents: ["make a photo background white", "how to make the background white", "how to get a white background on photos", "how to get a white background", "white background photo", "put a photo on a white background", "white background for a product listing", "change a photo background to white"] },
  ],
  text: [
