export const SITE_NAME = "EveryKit QR";
export const KIT_NAME = "QR";
export const KIT_SLUG = "qr";
export const SITE_TAGLINE = "QR codes that never expire";
