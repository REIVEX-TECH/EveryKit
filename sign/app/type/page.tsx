...
export const metadata: Metadata = {
  ...
  alternates: { canonical: absoluteUrl("/type") },
};
...
export default function Page() {
  ...
  return (
    <>
      ...
      <ToolSwitcher current="type" />

      <div className="ek-shell py-10 sm:py-12">
        <h1 className="text-[30px] leading-tight sm:text-[34px]">Type your signature</h1>
