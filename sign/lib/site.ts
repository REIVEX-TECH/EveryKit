export const SITE_NAME = "EveryKit Sign";
export const KIT_NAME = "Sign";
export const KIT_SLUG = "sign";
export const SITE_TAGLINE = "Draw your signature, sign a PDF, done";
