export const SITE_NAME = "EveryKit Teach";
export const KIT_NAME = "Teach";
export const KIT_SLUG = "teach";
export const SITE_TAGLINE = "Classroom tools that save teachers time";
