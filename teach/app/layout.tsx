...
export const metadata: Metadata = {
  ...
  description:
    "Classroom tools that save teachers time: rubrics, a gradebook, worksheets, a random picker, groups, seating, attendance, certificates, a timetable, a timer and grade curving. All of it in your browser.",
