...
export const metadata: Metadata = {
  title: "Privacy",
  description:
    "What EveryKit Teach does and does not collect. Your students' names and their marks stay in your browser. If you give us your email, we store that.",
  ...
  return (
    <div className="ek-shell max-w-[680px] py-16">
      ...
      <div className="mt-10 space-y-8 text-[16px] text-text-light">
        <section>
          <h2 className="text-[19px] text-foreground">Your class</h2>
          <p className="mt-2">
            Your students&apos; names and their marks are never uploaded. Every tool runs in
            the browser tab. There is no server that receives any of it, because this kit
            does not have a backend at all.
          </p>
          <p className="mt-2">
            Nothing is saved either. What you type lives in the tab&apos;s memory while you
            work and is gone when you close it. The gradebook keeps no students and the
            attendance sheet keeps no register.
          </p>
          <p className="mt-2">
        ...
        <section>
          ...
          <p className="mt-2">
            To be precise rather than merely reassuring: the statistics, the layout and the
            chime are written here and served with the page. The PDF and image exports are
            drawn on your device by a bundled library, not a service, so there is no
            third-party download and nothing to upload.
          </p>
          <p className="mt-2">
        ...
        <section>
          ...
          <p className="mt-2">
            Before your first download or copy we ask for your email address, and it is
            required. There is no skip link. You are asked once per session; after that every
            download and copy in that session goes straight through.
          </p>
          <p className="mt-2">
            ...
            linked to your class, because none of that reaches us. We use it to tell you when
            a new kit launches. We do not sell it and we do not pass it on.
          </p>
          <p className="mt-2">
            To be removed, email{" "}
