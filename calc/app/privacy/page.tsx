...
export const metadata: Metadata = {
  title: "Privacy",
  description:
    "What EveryKit Calc does and does not collect. Your date of birth, your loan and everything else stay in your browser. If you give us your email, we store that.",
    ...
    <div className="ek-shell max-w-[680px] py-16">
      ...
      <div className="mt-10 space-y-8 text-[16px] text-text-light">
        <section>
          ...
          <p className="mt-2">
            It is never uploaded. Every calculation runs in the browser tab. There is no
            server that receives your date of birth, your loan or anything else, because
            this kit does not have a backend at all.
          </p>
          <p className="mt-2">
            Nothing is saved either. What you type lives in the tab&apos;s memory while you
            work and is gone when you close it. There is no history and nothing to clear.
          </p>
          <p className="mt-2">
            You do not have to take this on trust. Open your browser&apos;s developer tools,
            switch to the network tab, and use any calculator on this site. No request
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            the work at all. Every calculation is written here and served with the page, so
            there is no third-party download.
          </p>
          <p className="mt-2">
            ...
            this page is allowed to contact. What you type is not on that list, and could not be
        ...
        <section>
          ...
          <p className="mt-2">
            Before your first copy we ask for your email address. You do not have
            to give it: a skip link takes you straight to your result. You are
            asked once per session, whether you enter it or skip, so after that
            every copy in that session goes straight through.
          </p>
          <p className="mt-2">
            ...
            linked to anything you calculated, because none of that reaches us. We use it to
