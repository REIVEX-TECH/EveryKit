...
import { AgeTool } from "@/components/calc/AgeTool";
import { DateDifferenceTool } from "@/components/calc/DateDifferenceTool";
...
/** Five static pages, one per calculator. Nothing here is rendered on demand. */
