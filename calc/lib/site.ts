export const SITE_NAME = "EveryKit Calc";
export const KIT_NAME = "Calc";
export const KIT_SLUG = "calc";
export const SITE_TAGLINE = "Everyday calculators that just answer";
