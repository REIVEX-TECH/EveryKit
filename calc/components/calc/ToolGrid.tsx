...
/**
 * The calculators as a launcher, filtered by a row of category chips.
 *
 ...
 * and a crawler sees the whole set; clicking a chip filters the grid.
 */
export function ToolGrid() {
  ...
  return (
    <div>
      ...
      <ul className="mt-8 grid grid-cols-4 gap-x-3 gap-y-6 sm:grid-cols-5">
        {visible.map((tool) => (
          <li key={tool.slug}>
            <Link
              href={`/${tool.slug}`}
